...
class TestCapitulo7BusquedasRestantes(unittest.TestCase):
    ...
    def test_comparison_runs_all_searches_on_same_array(self):
        ...
        self.assertIn("grid-template-columns: minmax(180px, 240px) 96px {array_width + 42}px;", source)
        self.assertIn("comparison-array-result-wrap", source)
        self.assertIn("comparison-array-head-label", source)
        self.assertIn("gap: 8px;", source)
        ...
        self.assertIn("grid-template-columns: minmax(180px, 240px) 96px 474px;", html)
        self.assertIn("width: 432px;", html)
        self.assertIn("width: 474px;", html)
