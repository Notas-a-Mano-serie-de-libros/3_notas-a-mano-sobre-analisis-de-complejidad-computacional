...
class TestCapitulo7BusquedasRestantes(unittest.TestCase):
    ...
    def test_comparison_target_mode_controls_membership(self):
        ...
        self.assertIn("disabled=True", source)
        self.assertIn('target_controls_column = widgets.VBox(', source)
        self.assertIn('[control_groups["target_mode"], control_groups["target_position"]]', source)
        self.assertIn("reserved_position_column = widgets.Box(", source)
