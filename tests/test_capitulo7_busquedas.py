...
class TestCapitulo7BusquedaTernaria(unittest.TestCase):
    ...
    def test_original_ui_features_are_present(self):
        ...
        self.assertIn('ui_state["first_row"].layout.grid_template_columns', common_source)
...
class TestCapitulo7BusquedasRestantes(unittest.TestCase):
    ...
    def test_comparison_runs_all_searches_on_same_array(self):
        ...
        self.assertIn("grid-template-columns: minmax(170px, 232px) 88px {array_width + 38}px;", source)
        ...
        self.assertIn("grid-template-columns: minmax(170px, 232px) 88px 470px;", html)
        self.assertIn("width: 432px;", html)
        self.assertIn("width: 470px;", html)
    ...
    def test_comparison_target_mode_controls_membership(self):
        ...
        self.assertIn("disabled=True", source)
        self.assertIn('controls.append(control_groups["target_readout"])', source)
        ...
        self.assertIn('ui_state["first_row"].children = tuple(row_controls)', source)
        self.assertIn('ui_state["first_row"].layout.grid_template_columns', source)
