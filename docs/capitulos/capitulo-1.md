...
<li><a href="#11-conceptos-iniciales"><strong>Conceptos iniciales</strong></a></li>
<li><a href="#12-contexto-historico"><strong>Contexto histórico</strong></a></li>
<li><a href="#13-de-vuelta-al-contexto-actual"><strong>De vuelta al contexto actual</strong></a></li>
</ul>
</section>
...
<div class="history-timeline" role="region" aria-label="Línea de tiempo del análisis de complejidad">
<ol>
<li tabindex="0" aria-describedby="history-description-1"><img src="../../assets/images/historia/calculo.svg" alt="Ilustración de una máquina de cálculo" width="120" height="120"><div class="history-timeline__content"><span class="history-timeline__date">Siglo XIX</span><strong>Automatizar el cálculo</strong><p id="history-description-1" role="tooltip">Siglo XIX: Babbage y Lovelace: máquinas e instrucciones reproducibles.</p></div></li>
<li tabindex="0" aria-describedby="history-description-2"><img src="../../assets/images/historia/computabilidad.svg" alt="Ilustración de una cinta de máquina de Turing" width="120" height="120"><div class="history-timeline__content"><span class="history-timeline__date">Década de 1930</span><strong>Formalizar la computabilidad</strong><p id="history-description-2" role="tooltip">Década de 1930: Turing y Church: modelos matemáticos de lo que puede calcularse.</p></div></li>
<li tabindex="0" aria-describedby="history-description-3"><img src="../../assets/images/historia/clasificacion.svg" alt="Ilustración de un árbol de decisiones" width="120" height="120"><div class="history-timeline__content"><span class="history-timeline__date">1960–1970</span><strong>Clasificar los problemas</strong><p id="history-description-3" role="tooltip">1960–1970: Tiempo polinomial, P versus NP, reducciones y NP-completitud.</p></div></li>
<li tabindex="0" aria-describedby="history-description-4"><img src="../../assets/images/historia/recursos.svg" alt="Ilustración de recursos y comunicación en una red" width="120" height="120"><div class="history-timeline__content"><span class="history-timeline__date">Final del siglo XX</span><strong>Ampliar los recursos estudiados</strong><p id="history-description-4" role="tooltip">Final del siglo XX: Espacio, azar, comunicación y parámetros del problema.</p></div></li>
<li tabindex="0" aria-describedby="history-description-5"><img src="../../assets/images/historia/actualidad.svg" alt="Ilustración de un procesador" width="120" height="120"><div class="history-timeline__content"><span class="history-timeline__date">Siglo XXI</span><strong>Evaluar soluciones a escala</strong><p id="history-description-5" role="tooltip">Siglo XXI: Datos masivos, nube, IA y computación cuántica; comprender y revisar el código sigue siendo esencial.</p></div></li>
</ol>
</div>
