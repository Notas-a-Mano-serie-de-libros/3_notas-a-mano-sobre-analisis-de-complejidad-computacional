...
[Abrir en Google Colab](https://colab.research.google.com/github/Notas-a-Mano-serie-de-libros/3_notas-a-mano-sobre-analisis-de-complejidad-computacional/blob/main/capitulo2/notebooks/1_complejidad_constante.ipynb){ .md-button .md-button--primary target="_blank" rel="noopener noreferrer" }
