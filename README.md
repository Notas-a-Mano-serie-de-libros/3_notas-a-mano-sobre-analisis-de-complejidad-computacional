...
Este repositorio reúne las simulaciones interactivas de la segunda edición del libro, cuyos autores son:
...
<p align="center">
  <a href="https://github.com/Notas-a-Mano-serie-de-libros/3_notas-a-mano-sobre-analisis-de-complejidad-computacional/actions/workflows/ci.yml"><img src="https://github.com/Notas-a-Mano-serie-de-libros/3_notas-a-mano-sobre-analisis-de-complejidad-computacional/actions/workflows/ci.yml/badge.svg?branch=main" alt="Estado de CI"></a>
  <a href="https://github.com/Notas-a-Mano-serie-de-libros/3_notas-a-mano-sobre-analisis-de-complejidad-computacional/actions/workflows/pages.yml"><img src="https://github.com/Notas-a-Mano-serie-de-libros/3_notas-a-mano-sobre-analisis-de-complejidad-computacional/actions/workflows/pages.yml/badge.svg?branch=main" alt="Estado de GitHub Pages"></a>
  <a href="https://github.com/Notas-a-Mano-serie-de-libros/3_notas-a-mano-sobre-analisis-de-complejidad-computacional/actions/workflows/codeql.yml"><img src="https://github.com/Notas-a-Mano-serie-de-libros/3_notas-a-mano-sobre-analisis-de-complejidad-computacional/actions/workflows/codeql.yml/badge.svg?branch=main" alt="Estado de CodeQL"></a>
...
<table align="center">
  <tr>
    <td align="center">
      <a href="https://notas-a-mano-serie-de-libros.github.io/3_notas-a-mano-sobre-analisis-de-complejidad-computacional/" target="_blank" rel="noopener noreferrer">
      ...
      <br>
      <strong><a href="https://notas-a-mano-serie-de-libros.github.io/3_notas-a-mano-sobre-analisis-de-complejidad-computacional/" target="_blank" rel="noopener noreferrer">Consultar el complemento digital</a></strong>
    </td>
    <td align="center">
      <a href="https://www.amazon.com/dp/B0HJYGTGZM" target="_blank" rel="noopener noreferrer">
        <img src="https://raw.githubusercontent.com/Notas-a-Mano-serie-de-libros/3_notas-a-mano-sobre-analisis-de-complejidad-computacional/main/assets/qr/amazon-libro.png" width="168" alt="Código QR del libro disponible en Amazon">
      </a>
      <br>
      <strong><a href="https://www.amazon.com/dp/B0HJYGTGZM" target="_blank" rel="noopener noreferrer">Consultar el libro en Amazon</a></strong>
    </td>
  </tr>
</table>

Este repositorio reúne la implementación de todos los ejemplos y las animaciones presentados en el libro. Las simulaciones pueden ejecutarse en un entorno local mediante los pasos de instalación y ejecución descritos a continuación, o abrirse en **Google Colab** desde el enlace asociado en **GitHub Pages**, que sirve como complemento digital de la obra.
