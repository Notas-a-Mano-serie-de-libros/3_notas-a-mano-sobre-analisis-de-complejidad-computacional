...
def test_bootstrap_loads_the_shared_widget_engine_in_local_and_colab_runs():
    bootstrap = (
        Path(__file__).resolve().parents[2] / "simulaciones" / "capitulo6" / "runtime" / "colab_bootstrap.py"
    ).read_text(encoding="utf-8")
...
def test_recursive_lab_supports_requested_analysis_examples():
    from simulaciones.capitulo6.runtime.recursive_analysis_lab import ALGORITHMS
...
def test_book_examples_are_selectable_in_the_last_panel():
    from simulaciones.capitulo6.runtime.recursive_examples_analysis import EXAMPLES
    ...
    import json
    notebook = json.loads(
        (Path(__file__).resolve().parents[2] / "simulaciones" / "capitulo6" / "notebooks" / "0_laboratorio_analisis_recursivo.ipynb").read_text(encoding="utf-8")
    )
    page = (
        Path(__file__).resolve().parents[2] / "docs" / "laboratorios" / "capitulo-6"
...
def test_fibonacci_trace_distinguishes_total_calls_from_stack_depth():
    from simulaciones.capitulo6.runtime.recursive_analysis_lab import build_trace
...
def test_call_stack_places_original_problem_at_the_base_and_returns_in_reverse():
    from simulaciones.capitulo6.runtime.recursive_analysis_lab import _call_stack_panel, build_trace
...
def test_cost_expression_uses_base_and_recursive_cases():
    from simulaciones.capitulo6.runtime.recursive_analysis_lab import _cost_expression
...
def test_lab_provides_four_syntax_highlighted_languages():
    from simulaciones.capitulo6.runtime.recursive_analysis_lab import CODE_SNIPPETS, _highlight_code_line
...
def test_code_snippets_use_standard_multiline_indentation():
    from simulaciones.capitulo6.runtime.recursive_analysis_lab import CODE_SNIPPETS
...
def test_recursion_tree_uses_arrows_and_only_marks_base_cases():
    from simulaciones.capitulo6.runtime.recursive_analysis_lab import _tree_svg, build_trace
...
def test_code_panel_identifies_the_selected_language_with_a_logo():
    from simulaciones.capitulo6.runtime.recursive_analysis_lab import LANGUAGE_LOGOS, _language_logo
...
def test_code_panel_uses_white_background_and_numbered_gutter():
    from simulaciones.capitulo6.runtime.recursive_analysis_lab import _code_panel
...
def test_trace_highlights_each_executed_line_like_a_debugger():
    from simulaciones.capitulo6.runtime.recursive_analysis_lab import _code_panel, build_trace
...
def test_fast_power_debug_trace_visits_assignment_branch_and_return_lines():
    from simulaciones.capitulo6.runtime.recursive_analysis_lab import _language_line, build_trace
...
def test_playback_uses_event_specific_transition_delays():
    from simulaciones.capitulo6.runtime.recursive_analysis_lab import _event_delay, build_trace
...
def test_chapter_six_reference_notebooks_are_separated():
    root = Path(__file__).resolve().parents[2] / "simulaciones" / "capitulo6"
