...
def test_chapters_two_and_four_parameter_panels_use_aligned_columns():
    paths = (
        ...
        "simulaciones/capitulo4/runtime/experiment_ui.py",
    )
    for path in paths:
...
def test_chapter_three_control_sections_use_flex_wrap():
    module_source = source("simulaciones/capitulo3/runtime/asymptotic_animation.py")
...
def test_every_simulation_family_loads_the_shared_visual_system():
    expected_contracts = {
        "simulaciones/capitulo2/runtime/experimental_animation.py": '.constant-animation-root',
        "simulaciones/capitulo2/runtime/polynomial_animation.py": '.constant-animation-root',
        "simulaciones/capitulo3/runtime/asymptotic_animation.py": '#bo-wrap',
        "simulaciones/capitulo4/runtime/experiment_ui.py": '.constant-animation-root',
        "simulaciones/capitulo5/runtime/recursion_tree_animation.py": '.recursion-tree-root',
        "simulaciones/capitulo6/runtime/recursive_analysis_lab.py": '.recursive-analysis-lab',
