...
def test_capitulos_aplican_el_estilo_canonico_al_label_efectivo():
    ...
    recursion_source = (project_root / "simulaciones/capitulo5/runtime/recursion_tree_animation.py").read_text(encoding="utf-8")
    lab_source = (project_root / "simulaciones/capitulo6/runtime/recursive_analysis_lab.py").read_text(encoding="utf-8")
