...
SNAPSHOT_PATH = PROJECT_ROOT / "desarrollo" / "tests" / "fixtures" / "html_snapshots.json"
...
def main() -> None:
    ...
    if current != expected:
        print("Los snapshots HTML cambiaron. Ejecuta desarrollo/scripts/validate_html_snapshots.py --update si el cambio es intencional.", file=sys.stderr)
