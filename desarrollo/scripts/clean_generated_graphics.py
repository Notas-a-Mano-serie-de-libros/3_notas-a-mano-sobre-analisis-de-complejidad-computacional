...
def graphics_roots() -> list[Path]:
    return sorted(PROJECT_ROOT.glob("recursos/imagenes/capitulo[0-9]*/generadas"))
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Elimina las imágenes generadas dentro de recursos/imagenes de cada capítulo."
    )
    parser.add_argument(
        "--check",
        action="store_true",
