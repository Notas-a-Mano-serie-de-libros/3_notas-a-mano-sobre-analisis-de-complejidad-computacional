...
REQUIRED_FILES = (
    ...
    "capitulo2/runtime/theoretical_graphs.py",
    "capitulo2/runtime/polynomial_animation.py",
)

SIMULATION_MODULES = {
    "constant": "capitulo2.runtime.constant_animation",
    "polynomial_general": "capitulo2.runtime.polynomial_animation",
    "default": "capitulo2.runtime.complexity_animations",
}

RELOADABLE_MODULES = (
    "capitulo2.runtime.experimental_animation",
    "capitulo2.runtime.constant_animation",
    "capitulo2.runtime.complexity_animations",
    "capitulo2.runtime.polynomial_animation",
    "capitulo2.runtime.theoretical_graphs",
)
...
def find_project_root():
    for base in (Path.cwd(), *Path.cwd().parents):
        module = base / "capitulo2" / "runtime" / "constant_animation.py"
        if module.exists():
            return base
    return None
