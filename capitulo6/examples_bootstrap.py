...
def _project_root():
    for base in (Path.cwd(), *Path.cwd().parents):
        if (base / "capitulo6" / "recursive_examples_analysis.py").exists():
            return base
    return None
...
def _download_runtime():
    ...
    files = {
        "capitulo6/recursive_examples_analysis.py": "capitulo6/recursive_examples_analysis.py",
        "capitulo4/experimental_analysis.py": "capitulo4/experimental_analysis.py",
        "capitulo4/experiment_ui.py": "capitulo4/experiment_ui.py",
    }
    base_url = (
...
from capitulo6.recursive_examples_analysis import build_examples_panel
