...
def _project_root():
    for base in (Path.cwd(), *Path.cwd().parents):
        if (base / "simulaciones" / "capitulo6" / "runtime" / "recursive_examples_analysis.py").exists():
            return base
    return None
...
def _download_runtime():
    ...
    files = {
        ...
        "simulaciones/capitulo6/runtime/recursive_examples_analysis.py": "simulaciones/capitulo6/runtime/recursive_examples_analysis.py",
        "simulaciones/capitulo4/runtime/experimental_analysis.py": "simulaciones/capitulo4/runtime/experimental_analysis.py",
        "simulaciones/capitulo4/runtime/experiment_ui.py": "simulaciones/capitulo4/runtime/experiment_ui.py",
    }
    base_url = (
...
from simulaciones.capitulo6.runtime.recursive_examples_analysis import build_examples_panel
